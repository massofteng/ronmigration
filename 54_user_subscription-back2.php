...
$sql = "SELECT * FROM ro_user_profiles WHERE user_id > 618470 LIMIT 100000";
...
if ($result->num_rows > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // if($row['profile_current_upgrade']=="easy"){
        //     $package_id = 6;
        // }
        // else if($row['profile_current_upgrade']=="cool"){
        //     $package_id = 7;
        // }
        // else if($row['profile_current_upgrade']=="pro"){
        //     $package_id = 8;
        // }
        // else if($row['profile_current_upgrade']=="easy"){
        //     $package_id = 2;
        // }
        // else if($row['profile_current_upgrade']=="cool"){
        //     $package_id = 3;
        ...
        if ($payment_row) {
            ...
            $end_date = date('Y-m-d H:i:s', $payment_row['expiration']);
